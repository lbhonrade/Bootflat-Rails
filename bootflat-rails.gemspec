...
Gem::Specification.new do |s|
  ...
  s.authors     = ["Zak El Fassi", "Grzegorz Bizon", "Lambert Honrade"]
  s.email       = 'lambert@seertech.co'
  s.files	= `git ls-files`.split("\n")
  # s.test_files = `git ls-files -- test/*`.split("\n")
  s.homepage	= 'https://github.com/lbhonrade/Bootflat-Rails'
  s.license     = 'MIT'
  s.metadata	= { "issue_tracker" => "https://github.com/lbhonrade/Bootflat-Rails/issues" }

  s.add_development_dependency 'sass-rails', '~> 4.0'
  s.add_runtime_dependency 'sass', '~> 3.3.14'
